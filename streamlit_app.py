...
# ✅ Check if API key exists, or raise an error
#if not api_key:
#    raise ValueError("❌ Error: GOOGLE_API_KEY is missing! Set it in your .env file.")
...
if save_chat:
    ...
    st.session_state["messages"] = []
#    st.success("✅ Chat history saved on the server.")
